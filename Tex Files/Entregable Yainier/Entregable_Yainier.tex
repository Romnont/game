...
\begin{center}
\includegraphics[scale=0.5]{execute_order_66.png} 
\end{center}


\subsection{Naves}
Las naves están compuestas de imágenes tipo PNG de 500x413 pixeles. En ambas naves predomina el color gris con contorno negro, tienen también colores rojos, naranjas y amarillos para simular fuego saliendo de los motores. 
...
\begin{thebibliography}{0}
  ...
  \bibitem{Python2} https://www.python.org/

  \bibitem{Python3} https://www.python.org/

  \bibitem{Python4} https://www.python.org/
